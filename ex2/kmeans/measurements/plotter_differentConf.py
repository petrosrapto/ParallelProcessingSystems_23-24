...
while line:
    ...
    if tokens[0] == 'Final':
        for i in range(8):
            ...
            t = l.split()
            if count == 0:
                clusters_ser.append(list(map(float, t[2:3])))
            elif count == 1:
                clusters_1_thread.append(list(map(float, t[2:3])))
            elif count == 2:
                clusters_2_thread.append(list(map(float, t[2:3])))
            elif count == 3:
                clusters_4_thread.append(list(map(float, t[2:3])))
            elif count == 4:
                clusters_8_thread.append(list(map(float, t[2:3])))
            elif count == 5:
                clusters_16_thread.append(list(map(float, t[2:3])))
            elif count == 6:
                clusters_32_thread.append(list(map(float, t[2:3])))
            elif count == 7:
                clusters_64_thread.append(list(map(float, t[2:3])))
        count += 1
    if tokens[0] == 'nloops':
