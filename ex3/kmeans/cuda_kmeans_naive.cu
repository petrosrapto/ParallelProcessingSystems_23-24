						...
						int blockSize)
{
    ...
    double timer_gpu = 0, timer_transfers = 0 , timer_cpu = 0 , temp;
   ...
   //printf("GPU part: %lf \n" , 1000*timer_gpu);
   //printf("CPU <--> GPU transfers: %lf \n" , 1000*timer_transfers);
   //printf("CPU part: %lf \n" , 1000*timer_cpu);
